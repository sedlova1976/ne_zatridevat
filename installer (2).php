...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211210_d0bdd0b5d0b7d0b0d182d180d0b8d_4745ea9233dd4fb58118_20211225125210_archive.zip';
	const ARCHIVE_SIZE		 = '1025273';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '4745ea9-25125210';
    const SECONDARY_PACKAGE_HASH = 'db82230-25125210';
	const VERSION			 = '1.4.3';
